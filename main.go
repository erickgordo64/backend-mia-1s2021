...
func (db *cn) abrir() {
	db.db, _ = sql.Open("godror", "calificacion/1234@localhost:1521/xe")
...
//estruct para recibir registro de usuario
type usr struct {
